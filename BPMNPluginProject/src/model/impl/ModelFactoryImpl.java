...
public class ModelFactoryImpl extends EFactoryImpl implements ModelFactory {
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			...
			case ModelPackage.ABSTRACT_ACTIVITY: return createAbstractActivity();
			case ModelPackage.CONTEXT: return (EObject)createContext();
			default:
	 ...
	 * @generated
	 */
	public Map.Entry<String, String> createContext() {
