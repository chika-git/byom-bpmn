...
public class ModelSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case ModelPackage.ABSTRACT_ACTIVITY: {
				AbstractActivity abstractActivity = (AbstractActivity)theEObject;
				T result = caseAbstractActivity(abstractActivity);
				if (result == null) result = caseServiceTask(abstractActivity);
				if (result == null) result = caseTask(abstractActivity);
				if (result == null) result = caseActivity(abstractActivity);
				if (result == null) result = caseInteractionNode(abstractActivity);
				if (result == null) result = caseFlowNode(abstractActivity);
				if (result == null) result = caseFlowElement(abstractActivity);
				if (result == null) result = caseBaseElement(abstractActivity);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ModelPackage.CONTEXT: {
				@SuppressWarnings("unchecked") Map.Entry<String, String> context = (Map.Entry<String, String>)theEObject;
	 ...
	 * @generated
	 */
	public T caseContext(Map.Entry<String, String> object) {
		return null;
	}
